...
> לפי שהיה לנו את useContext היינו משתמשים ב Redux כדי לנהל את הסטייט הגלובלי שלנו, אבל עם useReducer ו- useContext אפשר להגיע לאותה תוצאה בדיוק, ואפילו המימוש יהיה יותר קל.
